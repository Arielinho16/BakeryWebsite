...
export const Informacion = () => {
    ...
    return (
        <div className="px-4 pt-5 my-5 text-center border-bottom">
            <h1 id="bienvenido">Robina's Bakery</h1>
            ...
            <div className="row" style={{ marginBottom: "80px", marginTop: "80px" }}>
            ...
            <div className="container marketing">  {/* Imagenes de los locales */}
                ...
                <div className="row featurette">
                    <div className="col-md-7">
                        ...
                        <p className="lead">Nuestro chef principal deleitando con una de sus especialidades</p>
                        <a href="#" >Ver en Tiktok</a>
                    </div>
                    <div className="col-md-5">
                        <video className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" id="videoNosotros" width="500" height="500" controls>
                ...
                <div className="row featurette">
                    <div className="col-md-7 order-md-2">
                        ...
                        <p className="lead">Nuestro otro chef principal preparando una de sus especialidades</p>
